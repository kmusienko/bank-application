...
public class ClientDaoImpl implements ClientDao {
    ...
    public ClientDaoImpl(Connection connection, AccountDao accountDao) {
    ...
    public Client save(Client client) {
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO PUBLIC.CLIENTS (NAME, GENDER, TEL, EMAIL, CITY, ACTIVE_ACCOUNT_ID) VALUES (?,?,?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
